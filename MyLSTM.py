...
import numpy as np
import pickle
from model import BiRNN,TextCNN,mylstm
...
train_iter,test_iter,vocab=get_data_iter(batch_size=100,max_len=50)
##网络实例化
embsize,num_hiddens=100,100
net=mylstm(len(vocab),num_hiddens,embsize,batch_size=100,device='cuda:0')
##读取预训练权重
